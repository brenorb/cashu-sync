# Exploration — Event-sourced multiwriter Cashu Sync

Status: **Deferred beyond v0**

This document preserves the original multiwriter event-graph design for future evaluation. It is not the v0 specification. The normative v0 design is in [`../spec.md`](../spec.md).
